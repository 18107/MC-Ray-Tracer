...
public abstract class ClassTransformer {
	...
	static {
		...
		transformers = new ClassTransformer[] {new MinecraftTransformer(), new EntityRendererTransformer(), new StitcherTransformer(), new ChunkTransformer(), new GuiOptionsTransformer()};
	}
